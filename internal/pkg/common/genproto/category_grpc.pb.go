...
type CategoryServiceClient interface {
	...
	GetCategoryByName(ctx context.Context, in *GetCategoryByNameRequest, opts ...grpc.CallOption) (*GetCategoryByNameResponse, error)
	// Update a category
...
func (c *categoryServiceClient) GetCategory(ctx context.Context, in *GetCategoryRequest, opts ...grpc.CallOption) (*GetCategoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/genproto.CategoryService/GetCategory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) GetCategoryByName(ctx context.Context, in *GetCategoryByNameRequest, opts ...grpc.CallOption) (*GetCategoryByNameResponse, error) {
	out := new(GetCategoryByNameResponse)
	err := c.cc.Invoke(ctx, "/genproto.CategoryService/GetCategoryByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *ListCategoriesRequest, opts ...grpc.CallOption) (*ListCategoriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/genproto.CategoryService/ListCategories", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCategoryServiceServer) GetCategoryByName(context.Context, *GetCategoryByNameRequest) (*GetCategoryByNameResponse, error) {
...
func _CategoryService_GetCategory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.CategoryService/GetCategory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CategoryService_GetCategoryByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.CategoryService/GetCategoryByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _CategoryService_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.CategoryService/ListCategories",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
